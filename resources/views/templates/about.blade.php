...
@section('content')
    ...
    <h3 class="section-subtitle">{{ $adminSection->subtitle }}</h3>
    <h2 class="section-heading">{{ $adminSection->heading }}</h2>
    <p class="section-description">{{ $adminSection->description }}</p>
    <div class="stats-container mt-4">
        <div class="row">
            <div class="col-md-4 col-6">
                <div class="stat-item">
                    <h3>{{ $adminSection->years_of_excellence }}</h3>
                    <p>Years of Excellence</p>
                </div>
            </div>
            <div class="col-md-4 col-6">
                <div class="stat-item">
                    <h3>{{ $adminSection->faculty_members }}</h3>
                    <p>Faculty Members</p>
                </div>
            </div>
            <div class="col-md-4 col-6">
                <div class="stat-item">
                    <h3>{{ $adminSection->student_success }}</h3>
                    <p>Student Success</p>
                </div>
            </div>
        </div>
